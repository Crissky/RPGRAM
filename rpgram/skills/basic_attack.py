...
if __name__ == '__main__':
    ...
    print(f'Multipliers Text: "{pha.multipliers_text}", Power: {pha.power}')
    print(f'CHARACTER.Physical Attack: {BASE_CHARACTER.cs.physical_attack}')
    print(f'Multipliers Text: "{pra.multipliers_text}", Power: {pra.power}')
    print(f'CHARACTER.Precision Attack: {BASE_CHARACTER.cs.precision_attack}')
    print(f'Multipliers Text: "{maa.multipliers_text}", Power: {maa.power}')
