...
ENEMY_CHANCE_TO_ATTACK_AGAIN_DICT = {
    EnemyStarsEnum.ONE.name: 0.65,
    EnemyStarsEnum.TWO.name: 0.70,
    EnemyStarsEnum.THREE.name: 0.75,
    EnemyStarsEnum.FOUR.name: 0.80,
    EnemyStarsEnum.FIVE.name: 0.85,
...
SECTION_TEXT_EXCOMMUNICATED = 'EXCOMUNICADO'
SECTION_TEXT_ALLY_ATTACK = 'ATAQUE ALIADO'
SECTION_TEXT_FAIL_ALLY_ATTACK = 'ATAQUE FALHOU'

SECTION_START_DICT = {
    SkillDefenseEnum.PHYSICAL: SECTION_HEAD_PHYSICAL_ATTACK_START,
    'Precision Attack': SECTION_HEAD_PRECISION_ATTACK_START,
    SkillDefenseEnum.MAGICAL: SECTION_HEAD_MAGICAL_ATTACK_START,
    SkillDefenseEnum.TRUE: SECTION_HEAD_TRUE_ATTACK_START,
}
SECTION_END_DICT = {
    SkillDefenseEnum.PHYSICAL: SECTION_HEAD_PHYSICAL_ATTACK_END,
    'Precision Attack': SECTION_HEAD_PRECISION_ATTACK_END,
    SkillDefenseEnum.MAGICAL: SECTION_HEAD_MAGICAL_ATTACK_END,
    SkillDefenseEnum.TRUE: SECTION_HEAD_TRUE_ATTACK_END,
}
