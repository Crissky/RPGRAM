...
PATTERN_PICROSS = (
    fr'{{{CALLBACK_KEY_LIST.index("picross_row")}:\d'
)
...
GOD_BAD_MOVE_FEEDBACK_TEXTS = [
    'Se isso foi uma jogada… então que os deuses me levem de volta ao jardim.',
    'Ah, que tragédia em três atos! Pena que vocês escreveram sem talento.',
    'Já vi crianças jogarem flores com mais precisão que isso.',
    'Foi ousado... ousadamente ruim.',
    'Nem as marionetes fariam uma jogada tão desastrada.',
    'Lento como uma escultura derretendo ao sol.',
    'Eu pedi uma jogada, e vocês me entregaram um ensaio fracassado.',
    'Isso não foi uma jogada, foi um tropeço com adorno.',
    'Até a sombra de um pintor cego teria feito melhor.',
    'Faltou ritmo, faltou cor… faltou tudo.',
    'Se essa jogada fosse um quadro, eu rasgaria a tela.',
    'Inspiração? Não. Isso foi pura improvisação sem graça.',
    'Um lance assim mancharia até o mural mais belo.',
    'Até as flores do meu templo murcharam com essa jogada.',
    'Vocês tentaram pintar uma obra-prima... com os dedos sujos de burrice.',
    'Foi como dançar fora do compasso com os dois pés amarrados.',
    'E eu achava que já tinha visto jogadas ruins... até agora.',
    'Isso foi o equivalente estratégico a colar lantejoulas num porco.',
    'Que jogada artística! Se arte significasse fracasso.',
    'Lamentável, mas pelo menos foi breve.',
    'Minha máscara sorri, mas por dentro estou chorando de vergonha alheia.',
    'É uma pena que não se ganhe prêmios por desastres cênicos.',
    'Essa jogada foi um quadro mal pendurado… e torto.',
    'Se isso fosse uma dança, vocês acabaram de pisar na própria alma.',
    ...
    'Essa jogada tinha a graça de uma estátua caindo de bunda.',
    'Chamam isso de estratégia? Eu chamo de teatro de horrores.',
