...
def get_details_text(option: str) -> str:
    ...
    if option == CALLBACK_GENERAL or option is None:
        ...
        text = (
            ...
            f'{EmojiEnum.ONE_HAND.value}`{EquipmentEnum.ONE_HAND.value}` '
            '(x1), '
            f'{EmojiEnum.TWO_HANDS.value}`{EquipmentEnum.TWO_HANDS.value}` '
            '(x2,5), '
        ...
        text = (
            ...
            f'{TrocadoEnum.TROCADO_POUCHES.value}'
            f'{EmojiEnum.TROCADO_POUCH.value}, '
            ...
            f'Além disso, as {TrocadoEnum.TROCADO_POUCHES.value}'
            f'{EmojiEnum.TROCADO_POUCH.value} '
